...
42. [2026 CVPR] **Looking Beyond the Window: Global-Local Aligned CLIP for Training-free Open-Vocabulary Semantic Segmentation** (based on ProxyCLIP) [[paper]](https://arxiv.org/pdf/2603.23030) [[code]](https://github.com/2btlFe/GLA-CLIP) [[note]](https://mp.weixin.qq.com/s/UPx2TAqD0ZssheWTSAppwA)
...
29. [2025 ICCV] **SAM3-Adapter: Efficient Adaptation of SAM3 for Camouflage Object Segmentation, Shadow Detection, and Medical Image Segmentation** [[paper]](https://arxiv.org/pdf/2511.19425) [[code]](https://github.com/tianrun-chen/SAM-Adapter-PyTorch) [[note]](https://mp.weixin.qq.com/s/RL1s-Y307vk1PAesPo034A) [[google]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=SAM3-Adapter%3A+Efficient+Adaptation+of+SAM3+for+Camouflage+Object+Segmentation%2C+Shadow+Detection%2C+and+Medical+Image+Segmentation&btnG=)
30. [2025 ICLR] **Cross the Gap: Exposing the Intra-modal Misalignment in CLIP via Modality Inversion** [[paper]](https://arxiv.org/pdf/2502.04263) [[code]](https://github.com/miccunifi/Cross-the-Gap?tab=readme-ov-file)
...
4. [2022 CVPR] **CLIMS: Cross Language Image Matching for Weakly Supervised Semantic Segmentation** [[paper]](https://arxiv.org/pdf/2203.02668) [[code]](https://github.com/CVI-SZU/CLIMS)
5. [2022 IEEE] **Looking Beyond Single Images for Weakly Supervised Semantic Segmentation Learning**  [[paper]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9760057) [[code]](https://github.com/GuoleiSun/MCIS_wsss)
6. [2023 CVPR] **Learning Multi-Modal Class-Specific Tokens for Weakly Supervised Dense Object Localization** [[paper]](https://openaccess.thecvf.com/content/CVPR2023/papers/Xu_Learning_Multi-Modal_Class-Specific_Tokens_for_Weakly_Supervised_Dense_Object_Localization_CVPR_2023_paper.pdf) [[code]](https://github.com/xulianuwa/MMCST)
7. [2023 ICCV] **Spatial-Aware Token for Weakly Supervised Object Localization** [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Wu_Spatial-Aware_Token_for_Weakly_Supervised_Object_Localization_ICCV_2023_paper.pdf) [[code]](https://github.com/wpy1999/SAT)
8. [2023 CVPR] **Boundary-enhanced Co-training for Weakly Supervised Semantic Segmentatio** [[paper]](https://openaccess.thecvf.com/content/CVPR2023/papers/Rong_Boundary-Enhanced_Co-Training_for_Weakly_Supervised_Semantic_Segmentation_CVPR_2023_paper.pdf) [[code]](https://github.com/ShenghaiRong/BECO?tab=readme-ov-file)
9. [2023 CVPR] **ToCo:Token Contrast for Weakly-Supervised Semantic Segmentation** [[paper]](https://arXiv.org/pdf/2303.01267) [[code]](https://github.com/rulixiang/ToCo)
10. [2023 CVPR] **CLIP is Also an Efficient Segmenter: A Text-Driven Approach for Weakly Supervised Semantic Segmentation** [[paper]](https://arxiv.org/pdf/2212.09506) [[code]](https://github.com/linyq2117/CLIP-ES) [[google]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=CLIP+is+Also+an+Efficient+Segmenter%3A+A+Text-Driven+Approach+for+Weakly+Supervised+Semantic+Segmentation&btnG=)
...
18. [2024 CVPR] **Official code for Class Tokens Infusion for Weakly Supervised Semantic Segmentation** [[paper]](Yoon_Class_Tokens_Infusion_for_Weakly_Supervised_Semantic_Segmentation_CVPR_2024_paper) [[code]](https://github.com/yoon307/CTI)
19. [2024 CVPR] **Separate and Conquer: Decoupling Co-occurrence via Decomposition and Representation for Weakly Supervised Semantic Segmentation** [[paper]](https://arXiv.org/pdf/2402.18467) [[code]](https://github.com/zwyang6/SeCo)
20. [2024 CVPR] **Class Tokens Infusion for Weakly Supervised Semantic Segmentation** [[paper]](https://openaccess.thecvf.com/content/CVPR2024/papers/Yoon_Class_Tokens_Infusion_for_Weakly_Supervised_Semantic_Segmentation_CVPR_2024_paper.pdf) [[code]](https://github.com/yoon307/CTI)
...
28. [2024 IEEE] **Modeling the label distributions for weakly-supervised semantic segmentation** [[paper]](https://arxiv.org/pdf/2403.13225) [[code]](https://github.com/Luffy03/AGMM-SASS) [[note]](https://mp.weixin.qq.com/s/XhiJuB0pjeVgrsvVw98VOA)
29. [2025 CVPR] **POT: Prototypical Optimal Transport for Weakly Supervised Semantic Segmentation** [[paper]](https://openaccess.thecvf.com/content/CVPR2025/papers/Wang_POT_Prototypical_Optimal_Transport_for_Weakly_Supervised_Semantic_Segmentation_CVPR_2025_paper.pdf) [[code]](https://github.com/jianwang91/POT)
30. [2025 CVPR] **PROMPT-CAM: A Simpler Interpretable Transformer for Fine-Grained Analysis** [[paper]](https://arXiv.org/pdf/2501.09333) [[code]](https://github.com/Imageomics/Prompt_CAM)
31. [2025 CVPR] **Exploring CLIP’s Dense Knowledge for Weakly Supervised Semantic Segmentation** [[paper]](https://arXiv.org/pdf/2503.20826) [[code]](https://github.com/zwyang6/ExCEL)
32. [2025 CVPR] **Multi-Label Prototype Visual Spatial Search for Weakly Supervised Semantic Segmentation** [[paper]](https://openaccess.thecvf.com/content/CVPR2025/papers/Duan_Multi-Label_Prototype_Visual_Spatial_Search_for_Weakly_Supervised_Semantic_Segmentation_CVPR_2025_paper.pdf)
33. [2025 CVPR] **Prompt Categories Cluster for Weakly Supervised Semantic Segmentation** [[paper]](https://arXiv.org/pdf/2412.13823)
34. [2025 ICCV] **Class Token as Proxy: Optimal Transport-assisted Proxy Learning for Weakly Supervised Semantic Segmentation** [[paper]](https://openaccess.thecvf.com/content/ICCV2025/supplemental/Wang_Class_Token_as_ICCV_2025_supplemental.pdf) 
35. [2025 ICCV] **Know Your Attention Maps: Class-specific Token Masking for Weakly Supervised Semantic Segmentation** [[paper]](https://arxiv.org/pdf/2507.06848) [[code]](https://github.com/HSG-AIML/TokenMasking-WSSS)
36. [2025 ICCV] **Bias-Resilient Weakly Supervised Semantic Segmentation Using Normalizing Flows** [[paper]](https://openaccess.thecvf.com/content/ICCV2025/papers/Qiu_Bias-Resilient_Weakly_Supervised_Semantic_Segmentation_Using_Normalizing_Flows_ICCV_2025_paper.pdf) [[code]](https://github.com/DpDark/BRNF)
37. [2025 ICCV] **OVA-Fields: Weakly Supervised Open-Vocabulary Affordance Fields for Robot Operational Part Detection** [[paper]](https://openaccess.thecvf.com/content/ICCV2025/papers/Su_OVA-Fields_Weakly_Supervised_Open-Vocabulary_Affordance_Fields_for_Robot_Operational_Part_ICCV_2025_paper.pdf) [[code]](https://github.com/vlasu19/OVA-Fields)
