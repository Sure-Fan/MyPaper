...
## Dataset
1. **VOC**, **ADE20K**, **Context**, **COCO**, **DRIVE** and et al [[download]](https://mmsegmentation.readthedocs.io/zh-cn/latest/user_guides/2_dataset_prepare.html#drive) Note: You maybe also need helpful [[html]](https://docs.wand-py.org/en/latest/guide/install.html) to install other packages. The conversion code applied to directory names in the dataset can be found in **MaskCLIP**/tools/convert_datasets [[link]](https://github.com/chongzhou96/MaskCLIP/tree/master/tools/convert_datasets).
